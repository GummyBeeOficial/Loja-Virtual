-- Migration: Update place_order_atomic and order_items schema
-- Date: 2026-03-25

-- 1. Garantir que as colunas existem em order_items
ALTER TABLE public.order_items ADD COLUMN IF NOT EXISTS product_variant_id UUID;
ALTER TABLE public.order_items ADD COLUMN IF NOT EXISTS product_size_id UUID;
...
ALTER TABLE public.order_items ADD COLUMN IF NOT EXISTS product_image_snapshot TEXT;

-- 2. Atualizar a função place_order_atomic
